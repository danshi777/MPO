...
def main():
    ...
    parser.add_argument('--batch_size', type=int, default=8,
                       help='批处理大小')
    parser.add_argument('--save_dir', type=str, default=f"figs/pca",
    ...
    for lang in langs:
        args.compare_lang = lang
        harmful_path_en = f"{args.harmful_dir}/harmful_test_translated_en.json"
        harmless_path_en = f"{args.harmful_dir}/harmless_test_translated_en.json"
        harmful_path_other = f"{args.harmful_dir}/harmful_test_translated_{args.compare_lang}.json"
        harmless_path_other = f"{args.harmless_dir}/harmless_test_translated_{args.compare_lang}.json"
        ...
        if args.data_type == 'dpo':
            ...
            # English
            harmless_en, harmful_en = load_polyrefuse_data(harmful_path_en, harmless_path_en, args.max_samples)
        
            harmless_ot, harmful_ot = load_polyrefuse_data(harmful_path_other, harmless_path_other, args.max_samples)
