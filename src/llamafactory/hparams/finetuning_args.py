...
class RLHFArguments:
    ...
    margin_coef: Optional[float] = field(default=1.0, metadata={"help": "..."})
    retain_coef: Optional[float] = field(default=1.0, metadata={"help": "..."})
    margin_beta: Optional[float] = field(default=1.0, metadata={"help": "..."})
