...
# Example: 
# bash srun_train.sh examples/train_mpo/qwen2.5_mpo.yaml
# bash srun_train.sh examples/train_hpo/llama3.1_hpo.yaml
# bash srun_train.sh examples/train_hpo/llama3.1_simpo.yaml
# =========================================
